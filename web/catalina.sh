...
JAVA_OPTS="$JAVA_OPTS -Dext.prop.dir=$CATALINA_BASE/development -Dlog4j.configuration=$CATALINA_BASE/development/log4j.xml -Duser.language=es -Duser.region=PY -Duser.timezone=America/Asuncion"
